...
export const Footer = () => {
    return (
        <footer className="bg-brand-900 border-t border-white/5 relative overflow-hidden pt-16 pb-8">
            {/* Animated top border */}
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
                <div className="col-span-1 md:col-span-2">
                    ...
                    <div className="flex gap-4">
                        <a href="#" className="text-text-2 hover:text-white transition-colors"><Twitter className="w-5 h-5" /></a>
                        <a href="#" className="text-text-2 hover:text-white transition-colors"><Github className="w-5 h-5" /></a>
                        <a href="#" className="text-text-2 hover:text-white transition-colors"><Youtube className="w-5 h-5" /></a>
                    </div>
                </div>
